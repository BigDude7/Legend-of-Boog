...
namespace Legend_of_Boog.Services
{
    public static class StoryService
    {
        ...
        {
            UIService.Header();
            Console.WriteLine($"Old Dude: Incredible! I have never met a {player.Class} in person before! \n\nNow..{player.Name}, A hero is nothing without a trusty companion! I shall forge you a weapon! \nAs a {player.Class} like yourself, I entrust one of these two weapon types would suit you best?");
        }
